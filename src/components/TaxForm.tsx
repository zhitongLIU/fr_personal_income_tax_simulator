...
export function TaxForm({ onSubmit, year }: TaxFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md mb-8">
      ...
      <div className="mb-6">
        <label htmlFor="netIncome" className="block mb-2 font-semibold text-gray-800">
          Revenu net annuel (€) <span className="text-red-600">*</span>
        </label>
        <input
          type="number"
          id="netIncome"
          ...
          className="w-full px-3 py-3 text-base text-gray-900 bg-white border border-gray-300 rounded transition-all focus:outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-100"
        />
        <small className="block mt-2 text-sm text-gray-600 leading-relaxed p-3 bg-gray-50 border-l-4 border-blue-600 rounded">
      ...
      <div className="mb-6">
        <label htmlFor="maritalStatus" className="block mb-2 font-semibold text-gray-800">
          Situation familiale <span className="text-red-600">*</span>
        </label>
        <select
          id="maritalStatus"
          name="maritalStatus"
      ...
      <div className="mb-6">
        <label htmlFor="numberOfChildren" className="block mb-2 font-semibold text-gray-800">
      ...
      <div className="mb-6">
        <label htmlFor="deductions" className="block mb-2 font-semibold text-gray-800">
          Abattements (€)
        </label>
        <input
          type="number"
      ...
      <div className="mb-6">
        <label htmlFor="taxReductions" className="block mb-2 font-semibold text-gray-800">
          Réductions d'impôt (€)
        </label>
        <input
          type="number"
